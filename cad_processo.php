...
<script type="text/javascript">
    $(document).ready(function () {
        $('#empresa').change(function () {
            $('#empreendimento').load('exibe_empreendimento_processos.php?empresa=' + $('#empresa').val());
        });
    });
</script>
...
<div class="row">   
    <div class="col-sm-6">
        <h3><strong>CADASTRO DE PROCESSOS</strong></h3>
    </div>
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="form-group">                   
                            <label for="empreendimento"><strong>EMPREENDIMENTO / ATIVIDADE*</strong></label><button type="button" data-toggle="modal" data-target="#myModalcadEmpreendimento" class="btn btn-link">Caso não encontre, clique aqui para realizar o cadastro</button>                                    
